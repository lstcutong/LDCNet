...
from pointpd.utils.timer import Timer
from pointpd.utils.comm import is_main_process, synchronize, get_world_size
from pointpd.utils.cache import shared_dict
...
class DataCacheOperator(HookBase):
    ...
    def get_cache_name(self, data_path):
        ...
        return "pointpd" + data_name.replace(os.path.sep, "-")
