...
from pointpd.models.utils.serialization import encode, decode
from pointpd.models.utils import offset2batch, batch2offset


class Point(Dict):
    """
    Point Structure of pointpd

    A Point (point cloud) in pointpd is a dictionary that contains various properties of
